 ...
 * @since 1.0
 */
public class ActivitiFileCallable implements FileCallable<Boolean> {

    /** the serial version UID. */
    private static final long serialVersionUID = 4062942906170043360L;

    private final BuildListener listener;
    private final AbstractBuild<?, ?> build;
    private final String pathToWorkflow;

    public ActivitiFileCallable(BuildListener listener, AbstractBuild<?, ?> build, String pathToWorkflow) {
