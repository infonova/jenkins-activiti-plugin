...
public class CustomCallActivityParseHandlerUTest {
    ...
    public void testDeployProcess() throws FileNotFoundException {
        URL url = getClass().getResource("callactivity.bpmn20.xml");
        ...
        Assert.notNull(activity.getProperty(CustomCallActivityParseHandler.CALLACTIVITY_PROPERTY));
    }
